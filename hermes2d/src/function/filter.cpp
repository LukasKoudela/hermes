...
namespace Hermes
{
  namespace Hermes2D
  {
    ...
    template<typename Scalar>
    Func<Scalar>* SimpleFilter<Scalar>::calculate(int element_id, double* x_phys, double* y_phys, double* x_ref, double* y_ref, int np, double2x2* inv_ref_map)
    {
      return NULL;
    }
    ...
    Func<double>* ComplexFilter::calculate(int element_id, double* x_phys, double* y_phys, double* x_ref, double* y_ref, int np, double2x2* inv_ref_map)
    {
      return NULL;
    }
    ...
    Func<double>* VonMisesFilter::calculate(int element_id, double* x_phys, double* y_phys, double* x_ref, double* y_ref, int np, double2x2* inv_ref_map)
    {
      return NULL;
    }
